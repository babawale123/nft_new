  ...
  return (
    <div className="container mx-auto p-8">
      <div className="flex items-center justify-center text-white text-[36px] mb-10 font-[600]">
        <h1>Most popular live auctions</h1>
      </div>
      {/* Main card container */}
      <div className="flex flex-wrap gap-8 justify-center">
        {cards.map((card) => (
          <div
            key={card.id}
            className={`max-w-xs h-[600px] rounded-lg border-gray-500 overflow-hidden shadow-lg flex-shrink-0 ${card.bgColor === "white" ? "bg-white" : "bg-[#060714]"} `}
          >
            <img
              className="w-[300px] h-[400px] object-cover p-4 rounded-[30px]"
              src={card.image}
